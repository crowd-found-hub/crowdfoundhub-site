...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('smtp.sendgrid.net', 2525, 'tls' )
	  ->setUsername('getfoundhub')     
	  ->setPassword('2BtvUGN8K8cXm!!xyXw8AeSeVa%XxE2')
	  ;
	...
	$message = Swift_Message::newInstance('A message from Crowd Found')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('admin@crowdfoundhub.io' => 'Admin'))->setBody($messageText);
//                           ^                    ^
